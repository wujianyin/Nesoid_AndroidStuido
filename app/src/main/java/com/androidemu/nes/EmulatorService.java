...
//            notification.setLatestEventInfo(this, getText(R.string.app_label),
//                    text, contentIntent);

            NotificationCompat.Builder builder = new NotificationCompat.Builder(this, "Nesoid");
            builder.setSmallIcon(R.drawable.app_icon)
                    .setContentText(text)
                    .setContentText(getText(R.string.app_label))
